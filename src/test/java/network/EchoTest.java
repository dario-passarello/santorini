...
public class EchoTest {
    ...
    public void networkTest() {
        ...
        ClientDriver client1 = new ClientDriver("127.0.0.1",Server.DEFAULT_SERVER_SOCKET_PORT);
        Thread listenerThread1 = new Thread(client1);
        ClientDriver client2 = new ClientDriver("127.0.0.1",Server.DEFAULT_SERVER_SOCKET_PORT);
